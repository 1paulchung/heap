...
public class ArrayHeapMinPQTests extends BaseTest {
    ...
    class Add10Arbitrary extends Add10Increasing {
        ...
        @Test
        void ChangePriority_returnsCorrectOrder() {
            ExtrinsicMinPQ<Integer> pq = setUpMinPQ();
            pq.changePriority(1, 11);
            pq.changePriority(2, 12);

            assertThat(pq).isValid();
        }

        @Test
        void ChangePrioritywithPercolation_returnsCorrectOrder() {
            ExtrinsicMinPQ<Integer> pq = setUpMinPQ();
            pq.add(11, 3);
            for (int i = 1; i < 10; i++) {
                pq.changePriority(i, i % 3);
            }
            assertThat(pq).isValid();
        ...
        @Override
        void removeMinRepeatedly_returnsItemsInCorrectOrder() {
            super.removeMinRepeatedly_returnsItemsInCorrectOrder();
        }
    }
